...
const StyledFooter = styled.footer`
  background: url("bg-pattern-footer-mobile.svg"), var(--color-very-light-gray);
        ...
        <NavContainer>
          <Nav>
            ...
            <NavList>
              ...
              <NavItem>
                <NavLink href="#">Why Insure?</NavLink>
              </NavItem>
              <NavItem>
                <NavLink href="#">View plans</NavLink>
              </NavItem>
              <NavItem>
